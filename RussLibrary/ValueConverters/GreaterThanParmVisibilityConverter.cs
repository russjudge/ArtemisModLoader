...
namespace RussLibrary.ValueConverters
{
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Parm"), ValueConversion(typeof(decimal), typeof(Visibility))]
    public class GreaterThanParmVisibilityConverter : IValueConverter
    {
        static readonly ILog _log = LogManager.GetLogger(typeof(GreaterThanParmVisibilityConverter));
