...
namespace RussLibrary
{
    ...
    internal class ShellContextMenu : NativeWindow
    {
        ...
        //[SecurityPermission(SecurityAction.LinkDemand, Flags = SecurityPermissionFlag.UnmanagedCode), SecurityCritical]
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1806:DoNotIgnoreMethodResults", MessageId = "RussLibrary.ShellContextMenu+IContextMenu.InvokeCommand(RussLibrary.ShellContextMenu+CMINVOKECOMMANDINFOEX@)")]
        ...
        private IShellFolder GetDesktopFolder()
        {
            ...
            if (null == _oDesktopFolder)
            {
                ...
                int nResult = NativeMethods.SHGetDesktopFolder(out pUnkownDesktopFolder);
                if (S_OK != nResult)
                {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1806:DoNotIgnoreMethodResults", MessageId = "RussLibrary.NativeMethods.StrRetToBuf(System.IntPtr,System.IntPtr,System.Text.StringBuilder,System.Int32)")]
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "arr"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "PIDLs"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "PIDLs")]
        ...
        //////        uint nDefaultCmd = NativeMethods.GetMenuDefaultItem(pMenu, 0, 0);
        ...
        //}
        public void ShowContextMenu(FileInfo file, System.Windows.Point screenPoint)
        {
            List<FileInfo> f = new List<FileInfo>();
            f.Add(file);
            ShowContextMenu(f.ToArray(), screenPoint);
        ...
        public void ShowContextMenu(FileInfo[] files, System.Windows.Point screenPoint)
        {
            SetFiles(files);
            this.ShowContextMenu(screenPoint);
        }
        public void ShowContextMenu(string path, System.Windows.Point screenPoint)
        {
            if (!string.IsNullOrEmpty(path) && (File.Exists(path) || Directory.Exists(path)))
            {
                if ((File.GetAttributes(path) & FileAttributes.Directory) == FileAttributes.Directory)
                {
                    ShowContextMenu(new DirectoryInfo(path), screenPoint);
                }
                else
                {
                    ShowContextMenu(new FileInfo(path), screenPoint);
                }
            }
        ...
        /// <param name="pointScreen">Where to show the menu</param>
        //[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "dirs")]
        ...
        //    this.ShowContextMenu(pointScreen);
        //}
        void SetDirectories(DirectoryInfo[] dirs)
        {
            // Release all resources first.
            ReleaseAll();
            _arrPIDLs = GetPIDLs(dirs);
        }
        public void ShowContextMenu(DirectoryInfo directory, System.Windows.Point screenPoint)
        {
            List<DirectoryInfo> dirs = new List<DirectoryInfo>();
            dirs.Add(directory);
            ShowContextMenu(dirs.ToArray(), screenPoint);

        }
        public void ShowContextMenu(DirectoryInfo[] directories, System.Windows.Point screenPoint)
        {
            SetDirectories(directories);
            this.ShowContextMenu(screenPoint);
        }
        private void ShowContextMenu(System.Windows.Point pointScreen)
        {
            
            Point p = new Point(Convert.ToInt32 (pointScreen.X), Convert.ToInt32(pointScreen.Y));
            ShowContextMenu(p);
        }
        /// <summary>
        /// Shows the context menu
        ...
        /// <param name="pointScreen">Where to show the menu</param>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1806:DoNotIgnoreMethodResults", MessageId = "RussLibrary.ShellContextMenu+IContextMenu.QueryContextMenu(System.IntPtr,System.UInt32,System.UInt32,System.UInt32,RussLibrary.ShellContextMenu+CMF)")]
        ...
        private interface IShellFolder
        {
            ...
            Int32 GetDisplayNameOf(
                ...
                SHGNO uFlags,
                IntPtr lpName);
            //lpName should be: RussLibrary.NativeMethods.STRRET
    ...
    public class ShellContextMenuException : Exception
    {
        ...
        public ShellContextMenuException(string message, Exception innerException) : base(message, innerException) { }
    }
    #endregion
    ...
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Param"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "w")]
    //    public IntPtr wParam { get; set; }	// WPARAM argument
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Param"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "l")]
    ...
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "JOURNALRECORD")]
    //    WH_JOURNALRECORD = 0,
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1707:IdentifiersShouldNotContainUnderscores")]
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "JOURNALPLAYBACK")]
    ...
    //    WH_KEYBOARD = 2,
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1707:IdentifiersShouldNotContainUnderscores")]
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "GETMESSAGE")]
    //    WH_GETMESSAGE = 3,
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1707:IdentifiersShouldNotContainUnderscores")]
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "CALLWNDPROC")]
    //    WH_CALLWNDPROC = 4,
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1707:IdentifiersShouldNotContainUnderscores")]
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "CBT")]
    //    WH_CBT = 5,
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1707:IdentifiersShouldNotContainUnderscores")]
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "SYSMSGFILTER")]
    //    WH_SYSMSGFILTER = 6,
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1707:IdentifiersShouldNotContainUnderscores")]
    ...
    //    WH_HARDWARE = 8,
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1707:IdentifiersShouldNotContainUnderscores")]
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "DEBUG")]
    //    WH_DEBUG = 9,
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1707:IdentifiersShouldNotContainUnderscores")]
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "SHELL")]
    //    WH_SHELL = 10,
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1707:IdentifiersShouldNotContainUnderscores")]
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "FOREGROUNDIDLE")]
    //    WH_FOREGROUNDIDLE = 11,
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1707:IdentifiersShouldNotContainUnderscores")]
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "CALLWNDPROCRET")]
    ...
    //    internal NativeMethods.HookProc m_filterFunc = null;
    ...
    //    }
    //    internal LocalWindowsHook(HookType hook, NativeMethods.HookProc func)
    //    {
    //        m_hookType = hook;
    //        m_filterFunc = func;
    //    }
    ...
    //    // ************************************************************************
    //    // Uninstall the hook
    //    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1806:DoNotIgnoreMethodResults", MessageId = "RussLibrary.NativeMethods.UnhookWindowsHookEx(System.IntPtr)")]
