...
namespace VesselDataLibrary.Xml
{
  ...
  //<torpedo_storage type="3" amount="4" />  <!-- Type 9 ECM"-->
        public static readonly DependencyProperty TorpedoTypeProperty =
            DependencyProperty.Register(DataStrings.TorpedoType, typeof(int),
        ...
        public static readonly DependencyProperty QuantityProperty =
            DependencyProperty.Register(DataStrings.Quantity, typeof(int),
            typeof(TorpedoStorage));
        ...
        protected override void ProcessValidation()
        {
            ...
            {
                this.ValidationCollection.AddValidation(DataStrings.TorpedoType, ValidationValue.IsError, AMLResources.Properties.Resources.TorpedoTypeValidation);
            }
            if (Quantity < 0)
            {
                this.ValidationCollection.AddValidation(DataStrings.Quantity, ValidationValue.IsError,
                    string.Format(CultureInfo.CurrentCulture, AMLResources.Properties.Resources.GreaterThanZero, AMLResources.Properties.Resources.Quantity));
            }
        }
